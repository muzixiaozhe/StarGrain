...
public class UserSpaceController {
    ...
    public String saveProfile(@PathVariable("username") String username,User user) {
        ...
        boolean matches = encoder.matches(originalPassword, encodePassword);
        if (!matches){
    ...
    @PreAuthorize("authentication.name.equals(#username)")
    public ResponseEntity<ResultVO<User>> saveAvatar(@PathVariable("username") String username, @RequestBody User user) {
        ...
        return ResponseEntity.ok().body(new ResultVO(true, "处理成功", avatarUrl));
    }
     ...
     * @return
     */
    @GetMapping("/{username}/blogs/undefined")
    public String undefined(@PathVariable("username") String username, Model model) {
    ...
    @PreAuthorize("authentication.name.equals(#username)")
    public ModelAndView upBlog(@PathVariable("username") String username, @PathVariable("id") Long id,Model model) {
        Blog blog = blogService.getBlogById(id);
     ...
     * @return
     */
    @GetMapping("/{username}/blogs/edit/undefined")
    @PreAuthorize("authentication.name.equals(#username)")
    public String upSaveBlog(@PathVariable("username") String username) {
        return "redirect:/u/"+username+"/blogs";
    }
    ...
    @PreAuthorize("authentication.name.equals(#username)")
    public ResponseEntity<ResultVO> saveBlog(@PathVariable("username") String username, @RequestBody Blog blog) {
        // 对 Catalog 进行空处理
    ...
    @PreAuthorize("authentication.name.equals(#username)")
    public ResponseEntity<ResultVO> deleteBlog(@PathVariable("username") String username,@PathVariable("id") Long id) {
